...
LOW_ORDER_REPORT_PATH = (
    "docs/comparisons/ladenheim-canonical-108-low-order-evidence.md"
)
LOW_ORDER_RICE_SOURCE_ID = "rice-canonical-108-low-order-report"
LOW_ORDER_RICE_SOURCE_IDENTITY = {
    "source_type": "rice-documentation",
    "citation": "RICE low-order canonical-108 evidence report.",
}
# The low-order machine contract fixes identities, locators, structural facts,
# and computation payload/scope; explanatory prose remains human-reviewed.
...
LOW_ORDER_COMPUTATION_FIXED_PAYLOAD = {
    ...
    "input": (
        ...
        "one-, two-, and three-element coloured canonical fixtures"
    ),
    "operation": (
        "Construct all 25 fixtures, scan all 148 catalogue records under the "
        "committed structural relation, and verify unique subject matches and "
...
LOW_ORDER_COUNTS_BY_ELEMENT_ORDER = {"1": 3, "2": 6, "3": 16}
LOW_ORDER_SUBFAMILIES = {
    "IA", "IB", "IIA", "IIB", "IIIA", "IIIB", "IIIC", "IIID", "IIIE",
}
LOW_ORDER_FIGURE_LOCATOR = {
    "figure": "6.1", "printed_page": 50, "pdf_page_index": 56,
}
LOW_ORDER_CLASS_TABLE_LOCATOR = {
    "table": "6.11", "printed_page": 58, "pdf_page_index": 64,
}
LOW_ORDER_COUNT_TABLE_LOCATOR = {
    "table": "6.2", "printed_page": 49, "pdf_page_index": 55,
}
REVIEWED_LOW_ORDER_CANONICAL_NETWORKS = {
    1: ("lh148-11e22e7cba30a62f", "0-1:L", 1, (0, 1, 0), "IB", "I_B^1", 135, 141),
    2: ("lh148-187ef8e981d523c3", "0-1:C", 1, (0, 0, 1), "IB", "I_B^2", 135, 141),
    3: ("lh148-e6719ebfaa65ecc4", "0-1:R", 1, (1, 0, 0), "IA", "I_A^1", 135, 141),
    4: ("lh148-bc703386759e1fc4", "0-2:C;1-2:L", 2, (0, 1, 1), "IIB", "II_B^1", 136, 142),
    5: ("lh148-e5ab4cbd88b9cfcd", "0-2:C;1-2:R", 2, (1, 0, 1), "IIA", "II_A^3", 135, 141),
    6: ("lh148-dacf11ef419be4ae", "0-2:L;1-2:R", 2, (1, 1, 0), "IIA", "II_A^1", 135, 141),
    7: ("lh148-6c4acdd4ee210778", "0-1:C;0-1:L", 2, (0, 1, 1), "IIB", "II_B^2", 136, 142),
    8: ("lh148-33615cdca4d212bc", "0-1:L;0-1:R", 2, (1, 1, 0), "IIA", "II_A^2", 135, 141),
    9: ("lh148-e798eb374bc4314b", "0-1:C;0-1:R", 2, (1, 0, 1), "IIA", "II_A^4", 135, 141),
    10: ("lh148-ec2d91a9eb609e87", "0-2:C;1-3:L;2-3:R", 3, (1, 1, 1), "IIIE", "III_E^1", 137, 143),
    11: ("lh148-9ce47e2e00e47d8a", "0-2:L;0-2:R;1-2:L", 3, (1, 2, 0), "IIIB", "III_B^1", 136, 142),
    12: ("lh148-ba7c48b07f29dd51", "0-1:L;0-2:L;1-2:R", 3, (1, 2, 0), "IIIB", "III_B^1", 136, 142),
    13: ("lh148-4ec3374bd9f5ab9d", "0-1:C;0-2:C;1-2:R", 3, (1, 0, 2), "IIIB", "III_B^2", 136, 142),
    14: ("lh148-34b077a26df0d439", "0-2:C;0-2:R;1-2:C", 3, (1, 0, 2), "IIIB", "III_B^2", 136, 142),
    15: ("lh148-d0dd7ab06f8d9467", "0-2:L;0-2:R;1-2:R", 3, (2, 1, 0), "IIIA", "III_A^1", 136, 142),
    16: ("lh148-26ab596fc1b6adf0", "0-1:R;0-2:L;1-2:R", 3, (2, 1, 0), "IIIA", "III_A^1", 136, 142),
    17: ("lh148-f2ca341555f420ec", "0-2:C;0-2:R;1-2:R", 3, (2, 0, 1), "IIIA", "III_A^2", 136, 142),
    18: ("lh148-2d28eb19a83067c3", "0-1:R;0-2:C;1-2:R", 3, (2, 0, 1), "IIIA", "III_A^2", 136, 142),
    19: ("lh148-f6b0120a6632013a", "0-1:C;0-1:L;0-1:R", 3, (1, 1, 1), "IIIE", "III_E^2", 137, 143),
    26: ("lh148-aecc406cd94c57bc", "0-2:C;1-2:L;1-2:R", 3, (1, 1, 1), "IIIC", "III_C^4", 137, 143),
    27: ("lh148-c4dd949e0cc0cb9a", "0-2:C;0-2:L;1-2:R", 3, (1, 1, 1), "IIID", "III_D^1", 137, 143),
    34: ("lh148-81fbe344564bbcf0", "0-2:C;0-2:R;1-2:L", 3, (1, 1, 1), "IIIC", "III_C^2", 137, 143),
    41: ("lh148-6ab986b43f5cdc3d", "0-1:L;0-2:C;1-2:R", 3, (1, 1, 1), "IIIC", "III_C^1", 137, 143),
    42: ("lh148-0fa59ac63267cb6f", "0-1:R;0-2:C;1-2:L", 3, (1, 1, 1), "IIID", "III_D^2", 137, 143),
    49: ("lh148-7ad37b581984a1b6", "0-1:C;0-2:L;1-2:R", 3, (1, 1, 1), "IIIC", "III_C^3", 137, 143),
}
...
FIVE_ELEMENT_REPORT_PATH = (
    "docs/comparisons/ladenheim-canonical-108-five-element-evidence.md"
)
FIVE_ELEMENT_RICE_SOURCE_ID = "rice-canonical-108-five-element-report"
FIVE_ELEMENT_RICE_SOURCE_IDENTITY = {
    "source_type": "rice-documentation",
    "citation": "RICE five-element canonical-108 evidence report.",
}
FIVE_ELEMENT_AGGREGATE_ID = "rice-five-element-canonical-network-group"
FIVE_ELEMENT_COMPUTATION_ID = "rice-five-element-canonical-report-reproduction"
FIVE_ELEMENT_COMPUTATION_FIXED_PAYLOAD = {
    "cross_check_id": FIVE_ELEMENT_COMPUTATION_ID,
    "provenance_level": "independently-reproduced-computation",
    "implementation": (
        f"Structural-match reproduction commands in {FIVE_ELEMENT_REPORT_PATH} "
        "at the pinned evidence-only revision"
    ),
    "commit_sha": "b64946fd9ddcae6f764921d082b315affb9e233e",
    "input": (
        "The committed 148-record catalogue and 49 independently transcribed "
        "five-element coloured canonical fixtures"
    ),
    "operation": (
        "Construct all 49 fixtures, scan all 148 catalogue records under the "
        "committed structural relation, and verify unique subject matches, "
        "descriptors, component inventories, and complete five-element coverage"
    ),
    "result": (
        "The 49 independently transcribed canonical fixtures have 49 distinct "
        "unique RICE structural matches with agreeing reviewed descriptors and "
        "component inventories, exhausting the five-element population."
    ),
    "independently_reproduced": True,
    "limitations": (
        "The report reproduction was run at the pinned evidence-only revision, "
        "where it also checked the then-current 40 excluded / 49 unresolved / "
        "59 retained production boundary and that all 49 five-element subjects "
        "were unresolved. Those disposition checks document the historical "
        "acceptance state, are not part of the durable structural-match result, "
        "and are not intended to run unchanged after identity application. "
        "Current production validity is enforced by the current canonical-identity "
        "contract, generator, and tests; authoritative publication transcriptions "
        "remain source-verified inputs."
    ),
    "verification_state": "cross-checked",
}
FIVE_ELEMENT_COUNTS_BY_ELEMENT_ORDER = {"5": 49}
FIVE_ELEMENT_SUBFAMILIES = {"VA", "VB", "VC", "VD", "VE", "VF", "VG", "VH", "VI"}
FIVE_ELEMENT_FIGURE_LOCATOR = {
    "figure": "6.3",
    "printed_page": 51,
    "pdf_page_index": 57,
}
FIVE_ELEMENT_CLASS_TABLE_LOCATOR = {
    "table": "6.11",
    "printed_page": 59,
    "pdf_page_index": 65,
}
FIVE_ELEMENT_COUNT_TABLE_LOCATOR = {
    "table": "6.2",
    "printed_page": 49,
    "pdf_page_index": 55,
}
REVIEWED_FIVE_ELEMENT_CANONICAL_NETWORKS = {
    50: (
        "lh148-18bfb3d8c33bbf58",
        "0-2:L;0-2:R;0-3:L;1-2:R;2-3:R",
        (3, 2, 0),
        "VA",
        "V_A^1",
        (50, 54, 75, 79),
    ...
    51: (
        "lh148-3ae4767397da2b12",
        "0-2:L;0-2:R;0-3:R;1-3:R;2-3:L",
        (3, 2, 0),
        "VA",
        "V_A^1",
        (51, 55, 76, 80),
    ...
    52: (
        "lh148-3a5b171b0d2af32a",
        "0-2:L;0-2:R;0-3:L;1-3:R;2-3:R",
        (3, 2, 0),
        "VA",
        "V_A^1",
        (52, 56, 77, 81),
    ...
    53: (
        "lh148-4e1e2e1aa376f921",
        "0-2:L;0-2:R;1-3:L;1-3:R;2-3:R",
        (3, 2, 0),
        "VB",
        "V_B^1",
        (53, 57, 78, 82),
    ...
    54: (
        "lh148-1928fc6c03828cba",
        "0-1:R;0-2:L;0-2:R;1-3:L;2-3:R",
        (3, 2, 0),
        "VA",
        "V_A^1",
        (50, 54, 75, 79),
    ...
    55: (
        "lh148-ceda8e624931aa86",
        "0-1:R;0-2:L;0-3:L;1-2:R;2-3:R",
        (3, 2, 0),
        "VA",
        "V_A^1",
        (51, 55, 76, 80),
    ...
    56: (
        "lh148-44baa015c7dbccf2",
        "0-1:R;0-2:L;0-3:R;1-3:L;2-3:R",
        (3, 2, 0),
        "VA",
        "V_A^1",
        (52, 56, 77, 81),
    ...
    57: (
        "lh148-369eb555ae634258",
        "0-1:R;0-2:L;0-3:L;1-2:R;1-3:R",
        (3, 2, 0),
        "VB",
        "V_B^2",
        (53, 57, 78, 82),
    ...
    58: (
        "lh148-44371b2082f84fcf",
        "0-2:L;0-2:R;0-3:L;1-2:R;1-3:R",
        (3, 2, 0),
        "VB",
        "V_B^2",
        (58, 59, 83, 84),
    ...
    59: (
        "lh148-a33c22b118699e51",
        "0-2:L;0-2:R;1-2:R;1-3:L;2-3:R",
        (3, 2, 0),
        "VB",
        "V_B^1",
        (58, 59, 83, 84),
    ...
    60: (
        "lh148-2f4c974bc7831e4a",
        "0-2:L;0-3:R;1-2:R;1-3:R;2-3:L",
        (3, 2, 0),
        "VC",
        "V_C^1",
        (60, 85),
    ...
    61: (
        "lh148-c27124d195b882ef",
        "0-2:L;0-3:R;1-2:R;1-3:L;2-3:R",
        (3, 2, 0),
        "VD",
        "V_D^1",
        (61, 86),
    ...
    64: (
        "lh148-66a0391fd4dc6879",
        "0-2:C;0-2:R;0-3:R;1-3:R;2-3:L",
        (3, 1, 1),
        "VE",
        "V_E^2",
        (64, 67, 89, 92),
    ...
    65: (
        "lh148-8324b82e90bde552",
        "0-1:R;0-2:C;0-2:R;1-3:L;2-3:R",
        (3, 1, 1),
        "VE",
        "V_E^2",
        (65, 68, 91, 93),
    ...
    66: (
        "lh148-6456494eb91d8897",
        "0-1:R;0-2:C;0-3:R;1-3:L;2-3:R",
        (3, 1, 1),
        "VE",
        "V_E^2",
        (66, 69, 90, 94),
    ...
    67: (
        "lh148-e965ee7277ab24b2",
        "0-1:R;0-2:C;0-3:L;1-3:R;2-3:R",
        (3, 1, 1),
        "VE",
        "V_E^1",
        (64, 67, 89, 92),
    ...
    68: (
        "lh148-6bd2964e8fab676a",
        "0-2:C;0-3:L;0-3:R;1-3:R;2-3:R",
        (3, 1, 1),
        "VE",
        "V_E^1",
        (65, 68, 91, 93),
    ...
    69: (
        "lh148-e5953a9cf3d9cfa6",
        "0-2:C;0-2:R;0-3:L;1-3:R;2-3:R",
        (3, 1, 1),
        "VE",
        "V_E^1",
        (66, 69, 90, 94),
    ...
    70: (
        "lh148-1ea888a6b965ac39",
        "0-2:L;0-3:R;1-2:R;1-3:R;2-3:C",
        (3, 1, 1),
        "VH",
        "V_H^1",
        (70, 95),
    ...
    75: (
        "lh148-e7e64ac1f0778b53",
        "0-1:R;0-2:C;0-2:R;1-3:C;2-3:R",
        (3, 0, 2),
        "VA",
        "V_A^2",
        (50, 54, 75, 79),
    ...
    76: (
        "lh148-0c94f62def7dc462",
        "0-1:R;0-2:C;0-3:C;1-2:R;2-3:R",
        (3, 0, 2),
        "VA",
        "V_A^2",
        (51, 55, 76, 80),
    ...
    77: (
        "lh148-90a706c48f568ac5",
        "0-1:R;0-2:C;0-3:R;1-3:C;2-3:R",
        (3, 0, 2),
        "VA",
        "V_A^2",
        (52, 56, 77, 81),
    ...
    78: (
        "lh148-3398b6c5b497ac1f",
        "0-1:R;0-2:C;0-3:C;1-2:R;1-3:R",
        (3, 0, 2),
        "VB",
        "V_B^4",
        (53, 57, 78, 82),
    ...
    79: (
        "lh148-5c71fb151bc82017",
        "0-2:C;0-2:R;0-3:C;1-2:R;2-3:R",
        (3, 0, 2),
        "VA",
        "V_A^2",
        (50, 54, 75, 79),
    ...
    80: (
        "lh148-a99495648823d8f1",
        "0-2:C;0-2:R;0-3:R;1-3:R;2-3:C",
        (3, 0, 2),
        "VA",
        "V_A^2",
        (51, 55, 76, 80),
    ...
    81: (
        "lh148-0d78e9c38dc5b94e",
        "0-2:C;0-2:R;0-3:C;1-3:R;2-3:R",
        (3, 0, 2),
        "VA",
        "V_A^2",
        (52, 56, 77, 81),
    ...
    82: (
        "lh148-5af86517070376b6",
        "0-2:C;0-2:R;1-3:C;1-3:R;2-3:R",
        (3, 0, 2),
        "VB",
        "V_B^3",
        (53, 57, 78, 82),
    ...
    83: (
        "lh148-f54f327274744e9f",
        "0-2:C;0-2:R;1-2:R;1-3:C;2-3:R",
        (3, 0, 2),
        "VB",
        "V_B^3",
        (58, 59, 83, 84),
    ...
    84: (
        "lh148-cd4b770f5478f872",
        "0-2:C;0-2:R;0-3:C;1-2:R;1-3:R",
        (3, 0, 2),
        "VB",
        "V_B^4",
        (58, 59, 83, 84),
    ...
    85: (
        "lh148-9c9bca1b4c7a5c48",
        "0-2:C;0-3:R;1-2:R;1-3:R;2-3:C",
        (3, 0, 2),
        "VC",
        "V_C^2",
        (60, 85),
    ...
    86: (
        "lh148-5d2f2ceb56fb8299",
        "0-2:C;0-3:R;1-2:R;1-3:C;2-3:R",
        (3, 0, 2),
        "VD",
        "V_D^2",
        (61, 86),
    ...
    89: (
        "lh148-6601ce95cb4866ea",
        "0-2:C;0-3:R;1-3:R;2-3:L;2-3:R",
        (3, 1, 1),
        "VE",
        "V_E^4",
        (64, 67, 89, 92),
    ...
    90: (
        "lh148-d640e5a51b7f9267",
        "0-1:R;0-2:C;1-2:R;1-3:L;2-3:R",
        (3, 1, 1),
        "VE",
        "V_E^4",
        (66, 69, 90, 94),
    ...
    91: (
        "lh148-7f69006023a9ba91",
        "0-1:R;0-2:C;1-3:L;1-3:R;2-3:R",
        (3, 1, 1),
        "VE",
        "V_E^4",
        (65, 68, 91, 93),
    ...
    92: (
        "lh148-d83685d4a7f0cd41",
        "0-1:R;0-2:C;0-3:L;1-2:R;2-3:R",
        (3, 1, 1),
        "VE",
        "V_E^3",
        (64, 67, 89, 92),
    ...
    93: (
        "lh148-cd27971291cfaf9a",
        "0-2:C;0-2:R;0-3:L;1-2:R;2-3:R",
        (3, 1, 1),
        "VE",
        "V_E^3",
        (65, 68, 91, 93),
    ...
    94: (
        "lh148-75a667eae30e9bd2",
        "0-2:C;0-3:L;0-3:R;1-2:R;2-3:R",
        (3, 1, 1),
        "VE",
        "V_E^3",
        (66, 69, 90, 94),
    ...
    95: (
        "lh148-6ce044778ba295df",
        "0-2:C;0-3:R;1-2:R;1-3:R;2-3:L",
        (3, 1, 1),
        "VH",
        "V_H^2",
        (70, 95),
    ...
    98: (
        "lh148-ce4e4bbc3cb5bc7b",
        "0-2:C;0-2:R;1-3:L;1-3:R;2-3:R",
        (3, 1, 1),
        "VF",
        "V_F^2",
        (98, 101),
    ...
    99: (
        "lh148-ee8c722fe8f18278",
        "0-2:C;0-3:R;1-3:L;1-3:R;2-3:R",
        (3, 1, 1),
        "VF",
        "V_F^2",
        (99, 100, 102, 103),
    ...
    100: (
        "lh148-061515c41719c7cc",
        "0-2:C;0-2:R;1-2:R;1-3:L;2-3:R",
        (3, 1, 1),
        "VF",
        "V_F^2",
        (99, 100, 102, 103),
    ...
    101: (
        "lh148-1c63245475d83fd7",
        "0-1:R;0-2:C;0-3:L;1-2:R;1-3:R",
        (3, 1, 1),
        "VF",
        "V_F^1",
        (98, 101),
    ...
    102: (
        "lh148-d7f4be8bd126187c",
        "0-2:C;0-2:R;0-3:L;1-2:R;1-3:R",
        (3, 1, 1),
        "VF",
        "V_F^1",
        (99, 100, 102, 103),
    ...
    103: (
        "lh148-4b5da2aa5cfac0cc",
        "0-2:C;0-3:L;0-3:R;1-2:R;1-3:R",
        (3, 1, 1),
        "VF",
        "V_F^1",
        (99, 100, 102, 103),
    ...
    104: (
        "lh148-539216b2b01390c9",
        "0-2:C;0-3:L;1-4:R;2-4:R;3-4:R",
        (3, 1, 1),
        "VG",
        "V_G^1",
        (104, 106),
    ...
    105: (
        "lh148-4ce178b19ddf0bc8",
        "0-2:C;0-3:L;1-2:R;1-3:R;2-3:R",
        (3, 1, 1),
        "VG",
        "V_G^1",
        (105, 107),
    ...
    106: (
        "lh148-0d128fdfe5562143",
        "0-1:R;0-2:C;0-2:R;1-2:L;1-2:R",
        (3, 1, 1),
        "VG",
        "V_G^2",
        (104, 106),
    ...
    107: (
        "lh148-226210ea8617797f",
        "0-2:C;0-3:R;1-2:L;1-3:R;2-3:R",
        (3, 1, 1),
        "VG",
        "V_G^2",
        (105, 107),
    ...
    108: (
        "lh148-11e619a8865be381",
        "0-2:C;0-3:R;1-2:R;1-3:L;2-3:R",
        (3, 1, 1),
        "VI",
        "V_I",
        (108,),
...
def _reviewed_five_element_definition(number: int) -> dict[str, Any]:
    (
        _catalogue_id,
        _descriptor,
        inventory,
        ...
        class_page,
        class_index,
    ) = REVIEWED_FIVE_ELEMENT_CANONICAL_NETWORKS[number]
    return {
        "canonical_network_number": number,
        "fixture_id": f"ms-c108-five-{number}",
        "element_count": 5,
        "component_inventory": dict(zip(("r", "l", "c"), inventory, strict=True)),
        "subfamily": subfamily,
        "source_equivalence_class": equivalence_class,
...
CANONICAL_IDENTITY_GROUPS = {
    ...
    "five-element": {
        "networks": REVIEWED_FIVE_ELEMENT_CANONICAL_NETWORKS,
        "definition": _reviewed_five_element_definition,
        "fixture": lambda number: f"ms-c108-five-{number}",
        "aggregate_id": FIVE_ELEMENT_AGGREGATE_ID,
        "computation_id": FIVE_ELEMENT_COMPUTATION_ID,
        "report_path": FIVE_ELEMENT_REPORT_PATH,
        "rice_source_id": FIVE_ELEMENT_RICE_SOURCE_ID,
        "fixed_computation": FIVE_ELEMENT_COMPUTATION_FIXED_PAYLOAD,
        "counts_by_element_order": FIVE_ELEMENT_COUNTS_BY_ELEMENT_ORDER,
        "subfamilies": FIVE_ELEMENT_SUBFAMILIES,
        "orbit_count": 16,
        "equivalence_class_count": 21,
        "total_networks": 49,
        "count_table_locator": FIVE_ELEMENT_COUNT_TABLE_LOCATOR,
        "figure_locator": FIVE_ELEMENT_FIGURE_LOCATOR,
        "class_table_locator": FIVE_ELEMENT_CLASS_TABLE_LOCATOR,
    },
}
...
CLAIM_TYPES = {
    ...
    "aggregate-canonical-network-group",
}
IMMUTABLE_FIELDS = (
    "catalogue_id",
...
COMPUTATION_CANONICAL_SCOPE_FIELDS = {
    "subject_catalogue_ids",
...
def _validate_sources(values: Any) -> dict[str, dict[str, Any]]:
    ...
    reviewed_identities = {
        ...
        FIVE_ELEMENT_RICE_SOURCE_ID: FIVE_ELEMENT_RICE_SOURCE_IDENTITY,
    }
...
def _validate_claim(
    ...
    if claim_type == "catalogue-target":
    ...
    elif claim_type == "canonical-network-match":
        _validate_object_shape(
            claim,
            f"evidence {evidence_id} canonical-network match claim",
            {
                "claim_type",
                "subject_catalogue_ids",
        ...
        if (
            ...
            raise ValueError(
                f"evidence {evidence_id} has invalid canonical-network match claim"
            )
    elif claim_type == "aggregate-canonical-network-group":
        _validate_object_shape(
            claim,
            f"evidence {evidence_id} aggregate canonical-network claim",
            {
                "claim_type",
                "canonical_network_numbers",
                "subject_catalogue_ids",
                "counts_by_element_order",
                "subfamilies",
                "source_orbit_count",
...
def _validate_computational_cross_checks(
    ...
    for record_id, record in records.items():
        ...
        valid_scope_shapes = {
            ...
            frozenset(COMPUTATION_CANONICAL_SCOPE_FIELDS),
        }
        ...
        if present_scope_fields:
            ...
            if "canonical_network_numbers" in record:
                numbers = record["canonical_network_numbers"]
                definitions = record["canonical_definition_evidence_record_ids"]
                if (
                    not isinstance(numbers, list)
                    or not numbers
                    or not all(_is_int(value) and 1 <= value <= 108 for value in numbers)
                    or len(set(numbers)) != len(numbers)
                    or len(subjects) != len(numbers)
                ):
                    raise ValueError(
                        f"cross-check {record_id} has invalid canonical-number scope"
                    )
                _require_references(
                    definitions,
                    f"cross-check {record_id} canonical_definition_evidence_record_ids",
                    evidence,
                )
                if not definitions:
                    raise ValueError(
                        f"cross-check {record_id} canonical definition scope must not be empty"
                    )
            else:
                target_field = (
                    "reduction_target_network_numbers"
...
def _validate_assertion(
    ...
    *, catalogue_id: str | None = None,
    ...
    if status == "derived-canonical-identity-match":
        ...
        if basis != required:
            raise ValueError(
                "derived-canonical-identity-match requires exactly the canonical "
                "diagram and subject-bound RICE evidence basis"
            )
        if (
            disposition != "retain"
            or category != "none"
            ...
            raise ValueError(
                "derived-canonical-identity-match requires retention without "
                "exclusion metadata"
            )
        if assertion["basic_graph_assignment"] is not None:
            raise ValueError(
                "derived-canonical-identity-match requires no basic graph assignment"
            )
        definitions = _matching_evidence(
            evidence_ids, evidence, "canonical-network-definition"
        )
        matches = _matching_evidence(
            evidence_ids, evidence, "canonical-network-match"
        )
        aggregates = _matching_evidence(
            evidence_ids, evidence, "aggregate-canonical-network-group"
        )
        if len(definitions) != 1 or len(matches) != 1 or len(aggregates) != 1:
            raise ValueError(
                "derived-canonical-identity-match requires one definition, match, "
                "and aggregate group"
            )
        definition = definitions[0]
        match = matches[0]
        number = definition["claim"]["canonical_network_number"]
        if (
            not _is_authoritative(definition)
            or match["provenance_level"] != "rice-derived-structural-fact"
            or match["verification_state"] != "cross-checked"
            or match["claim"]["subject_catalogue_ids"] != [catalogue_id]
            or match["claim"]["canonical_network_number"] != number
            or match["claim"]["fixture_id"] != definition["claim"]["fixture_id"]
        ):
            raise ValueError(
                "derived-canonical-identity-match requires an exact joined "
                "definition and subject match"
            )
        identifiers = assertion["historical_identifiers"]
        if (
            len(identifiers) != 1
            or identifiers[0]["scheme"] != "morelli-smith-canonical-network"
            or identifiers[0]["value"] != number
            or identifiers[0]["verification_state"] != "cross-checked"
            or set(identifiers[0]["evidence_record_ids"])
    ...
    if disposition == "exclude":
        ...
        if status != "derived-canonical-identity-match" and not any(
            _is_authoritative(record)
...
def _validate_canonical_identity_groups(
    explicit: dict[str, dict[str, Any]],
    rules: list[dict[str, Any]],
    evidence: dict[str, dict[str, Any]],
    computations: dict[str, dict[str, Any]],
...
def generate_evidence_ledger(
    ...
    _validate_canonical_identity_groups(
        explicit, rules, evidence, computations, source_by_id
    )
