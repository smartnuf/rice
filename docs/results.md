...
planned Ladenheim comparison because it uses the implemented relation on a
nearby bounded slice. It is not presented as the historical 148 structural
catalogue or the 108 canonical Ladenheim catalogue.
